...
export * as env from "https://deno.land/std@0.223.0/dotenv/mod.ts";
...
export * as udm from "https://raw.githubusercontent.com/netspective-labs/sql-aide/v0.13.20/pattern/udm/mod.ts";
